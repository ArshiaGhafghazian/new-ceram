            ...
            <menu className={` transition-all relative`}>
              <ul className="flex flex-col  ">
                ...
                <NavLink
                  ...
                  className={getLinkClass("/dashboard/sliders")}
                >
                  <li>اسلایدرها</li>
                </NavLink>
                <NavLink
                ...
                <NavLink
                  ...
                  className={getLinkClass("/dashboard/subcategory")}
                >
                  {<li>زیر دسته بندی محصولات</li>}
                </NavLink>
                <NavLink
                  href="/dashboard/productUse"
                  className={getLinkClass("/dashboard/productUse")}
                >
                  <li>محل استفاده محصولات</li>
                </NavLink>
                <NavLink
                  href="/dashboard/productChracteristic"
                  className={getLinkClass("/dashboard/productChracteristic")}
                >
                  <li>مشخصات محصولات</li>
                </NavLink>
                <NavLink
                  href="/dashboard/cataloge"
                  className={getLinkClass("/dashboard/cataloge")}
                >
                  <li>کاتالوگ ها</li>
                </NavLink>
