...
const Category = () => {
    ...
    const getSubCategory = async () => {
        const url = apiUrl + `subcategory/${subCategoryId}`;
        setIsLoading(true)
        try {
            const res = await axios.get(url)
            ...
            //@ts-ignore
            const foundedCategory = categories.find(cat => cat._id === response.category._id)
            ...
            setFormValue({
                ...
                size: response.size,
                category: foundedCategory ? { label: foundedCategory?.name.fa, value: foundedCategory?._id } : { value: "", label: "" }
            })
    ...
    const deleteSubCategory = async (id: string) => {
        const url = apiUrl + "subcategory/" + id;
        setIsLoading(true)
        try {
        ...
        <>
                                                        ...
                                                        <AlertDialog>
                                                            ...
                                                            <AlertDialogContent dir="rtl">
                                                                ...
                                                                <AlertDialogFooter>
                                                                    ...
                                                                    <AlertDialogAction onClick={() => deleteSubCategory(category._id)}>تایید</AlertDialogAction>
                                                                </AlertDialogFooter>
                                                            </AlertDialogContent>
                                                        </AlertDialog>
            ...
            <Dialog
                ...
                <DialogContent dir="rtl" className="sm:max-w-6xl">
                    <DialogHeader>
                        <DialogTitle>ایجاد زیر  دسته بندی</DialogTitle>
                        <DialogDescription>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col gap-4">
                            <Label>نام  زیر  دسته بندی انگلیسی</Label>
                            <Input
                                type="text"
                        ...
                        <div className="flex flex-col gap-4">
                            <Label>نام  زیر  دسته بندی عربی</Label>
                            <Input
                                type="text"
                        ...
                        <div className="flex flex-col gap-4">
                            <Label>نام  زیر  دسته بندی روسی</Label>
                            <Input
                                type="text"
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <Combobox
                                ...
                                options={categories.map((category) => ({ label: category.name.fa, value: category._id }))}
                                onChange={(val) => { setFormValue(prev => ({ ...prev, category: val })) }} />
                    ...
                    <DialogFooter className="sm:justify-end mt-4">
                        ...
                        <Button onClick={subCategoryId !== undefined ? updateSubCategory : createSubCategory} type="button">{subCategoryId !== undefined ? "به روزرسانی" : "ذخیره"}</Button>
