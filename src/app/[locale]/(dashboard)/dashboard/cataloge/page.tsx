...
const Category = () => {
  ...
  const [cataloges, setCataloges] = useState<CategoryType[]>([]);
  ...
  const updateCataloge = async () => {
    ...
    setIsLoading(true);
    try {
      const res = await axios.patch(url, formValue, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("session")}`,
        },
      });
              ...
              <table className=" min-w-125 w-full bg-white  ">
                <thead>
                  <tr className="bg-zinc-300 text-xs md:text-sm text-black">
                    <th className="px-2 py-3 md:py-4 text-center w-1/4">
                      اولویت
                    </th>
                  ...
                  {isLoading
                    ...
                    : cataloges?.map((category, i) => (
                        ...
                        >
                          ...
                          <td className="p-1 py-3 text-center w-1/4">
                            <a
                              href={imageBaseUrl + category.image}
                              target="_blank"
                            >
                              <img
                                className="w-28 mx-auto cursor-pointer"
                                src={imageBaseUrl + category.image}
                                alt={imageBaseUrl + category.alt}
                              />
                            </a>
                          </td>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent dir="rtl">
                                ...
                                <AlertDialogFooter>
                                  ...
                                  <AlertDialogAction
                                    onClick={() => deleteCataloge(category._id)}
                                  >
                                    تایید
                                  </AlertDialogAction>
                                </AlertDialogFooter>
