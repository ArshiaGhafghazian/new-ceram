...
const Category = () => {
    ...
    const getProductUse = async () => {
        const url = apiUrl + `productUse/${productUseId}`;
        setIsLoading(true)
        try {
            const res = await axios.get(url)
    ...
    const deleteProductUse = async (id: string) => {
        const url = apiUrl + "productUse/" + id;
        setIsLoading(true)
        try {
        ...
        <>
            <div className="max-w-450 mx-auto px-8 md:px-16 mt-10">
                <div className="flex justify-between items-center">
                    ...
                    <h1 className="text-xl font-bold text-black">محل استفاده محصولات</h1>

                    <Button onClick={() => setIsOpen(true)}>
                        <span> محل استفاده محصول جدید</span>
                        <Plus />
                    </Button>
                </div>
            ...
            <Dialog
                ...
                <DialogContent dir="rtl" className="sm:max-w-6xl">
                    <DialogHeader>
                        <DialogTitle>ایجاد محل استفاده محصول</DialogTitle>
                        <DialogDescription>
